    ...
    <div class="container mb-5" style="max-width:90%;">
        ...
        <div class="row">
            <div class="col-12 col-lg-7">
                ...
                <div class="list-group shadow-sm mt-3">
                    <li class="list-group-item list-group-item-action mb-0 disabled">
                        <div class="d-flex">
                            ...
                            <h3 class="text-dark mt-2">288.465</h3>
                ...
                <button class="btn btn-danger mt-3 mb-3 shadow-sm">Cancel</button>
            </div>
                ...
                <div class="rounded bg-white shadow-sm p-3">
                    ...
                    <hr>
                        ...
                        <div class="form-group">
                            ...
                            <h5>Gold - Rp. 288.465</h5>
                        </div>
                </div>
                <div class="text-right">
                    <button class="btn btn-primary mt-3 shadow-sm">Confirm</button>
                </div>
            </div>
        </div>
    </form>
