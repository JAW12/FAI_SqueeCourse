...
@section('content')
    <div class="container my-5">
        ...
        <div class="col-12 col-md-6 shadow"
            ...
            strpos($series->url_foto_banner, 'https://') === false ?
            asset("storage/images/$series->url_foto_banner") : $series->url_foto_banner  }}'); background-size: cover;  background-position: center;">
        </div>
